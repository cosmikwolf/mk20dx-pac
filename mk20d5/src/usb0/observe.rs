...
#[doc = "Provides observability of the D- Pull Down enable at the USB transceiver.\n\nValue on reset: 1"]
...
#[doc = "Field `DMPD` reader - Provides observability of the D- Pull Down enable at the USB transceiver."]
...
#[doc = "Field `DPPD` reader - Provides observability of the D+ Pull Down enable at the USB transceiver."]
...
#[doc = "Provides observability of the D+ Pull Up enable at the USB transceiver.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Dppu {
...
#[doc = "Field `DPPU` reader - Provides observability of the D+ Pull Up enable at the USB transceiver."]
