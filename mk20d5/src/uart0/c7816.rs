...
impl W {
    #[doc = "Bit 0 - ISO-7816 Functionality Enabled"]
    #[inline(always)]
    pub fn iso_7816e(&mut self) -> Iso7816eW<'_, C7816Spec> {
        Iso7816eW::new(self, 0)
    }
    #[doc = "Bit 1 - Transfer Type"]
    #[inline(always)]
    pub fn ttype(&mut self) -> TtypeW<'_, C7816Spec> {
        TtypeW::new(self, 1)
    }
    #[doc = "Bit 2 - Detect Initial Character"]
    #[inline(always)]
    pub fn init(&mut self) -> InitW<'_, C7816Spec> {
        InitW::new(self, 2)
    }
    #[doc = "Bit 3 - Generate NACK on Error"]
    #[inline(always)]
    pub fn anack(&mut self) -> AnackW<'_, C7816Spec> {
        AnackW::new(self, 3)
    }
    #[doc = "Bit 4 - Generate NACK on Overflow"]
    #[inline(always)]
    pub fn onack(&mut self) -> OnackW<'_, C7816Spec> {
        OnackW::new(self, 4)
    }
}
