...
impl W {
    #[doc = "Bits 0:1 - Low-Voltage Detect Voltage Select"]
    #[inline(always)]
    pub fn lvdv(&mut self) -> LvdvW<'_, Lvdsc1Spec> {
        LvdvW::new(self, 0)
    }
    #[doc = "Bit 4 - Low-Voltage Detect Reset Enable"]
    #[inline(always)]
    pub fn lvdre(&mut self) -> LvdreW<'_, Lvdsc1Spec> {
        LvdreW::new(self, 4)
    }
    #[doc = "Bit 5 - Low-Voltage Detect Interrupt Enable"]
    #[inline(always)]
    pub fn lvdie(&mut self) -> LvdieW<'_, Lvdsc1Spec> {
        LvdieW::new(self, 5)
    }
    #[doc = "Bit 6 - Low-Voltage Detect Acknowledge"]
    #[inline(always)]
    pub fn lvdack(&mut self) -> LvdackW<'_, Lvdsc1Spec> {
        LvdackW::new(self, 6)
    }
}
