...
impl W {
    #[doc = "Bit 0 - no description available"]
    #[inline(always)]
    pub fn tcrc(&mut self) -> TcrcW<'_, CtrlhuSpec> {
        TcrcW::new(self, 0)
    }
    #[doc = "Bit 1 - no description available"]
    #[inline(always)]
    pub fn was(&mut self) -> WasW<'_, CtrlhuSpec> {
        WasW::new(self, 1)
    }
    #[doc = "Bit 2 - no description available"]
    #[inline(always)]
    pub fn fxor(&mut self) -> FxorW<'_, CtrlhuSpec> {
        FxorW::new(self, 2)
    }
    #[doc = "Bits 4:5 - no description available"]
    #[inline(always)]
    pub fn totr(&mut self) -> TotrW<'_, CtrlhuSpec> {
        TotrW::new(self, 4)
    }
    #[doc = "Bits 6:7 - no description available"]
    #[inline(always)]
    pub fn tot(&mut self) -> TotW<'_, CtrlhuSpec> {
        TotW::new(self, 6)
    }
}
