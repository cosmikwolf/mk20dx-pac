...
impl W {
    #[doc = "Bits 0:1 - Wakeup Pin Enable for LLWU_P4"]
    #[inline(always)]
    pub fn wupe4(&mut self) -> Wupe4W<'_, Pe2Spec> {
        Wupe4W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Wakeup Pin Enable for LLWU_P5"]
    #[inline(always)]
    pub fn wupe5(&mut self) -> Wupe5W<'_, Pe2Spec> {
        Wupe5W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Wakeup Pin Enable for LLWU_P6"]
    #[inline(always)]
    pub fn wupe6(&mut self) -> Wupe6W<'_, Pe2Spec> {
        Wupe6W::new(self, 4)
    }
    #[doc = "Bits 6:7 - Wakeup Pin Enable for LLWU_P7"]
    #[inline(always)]
    pub fn wupe7(&mut self) -> Wupe7W<'_, Pe2Spec> {
        Wupe7W::new(self, 6)
    }
}
