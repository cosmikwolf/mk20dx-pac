...
impl W {
    #[doc = "Bit 0 - Wakeup Flag for LLWU_P8"]
    #[inline(always)]
    pub fn wuf8(&mut self) -> Wuf8W<'_, F2Spec> {
        Wuf8W::new(self, 0)
    }
    #[doc = "Bit 1 - Wakeup Flag for LLWU_P9"]
    #[inline(always)]
    pub fn wuf9(&mut self) -> Wuf9W<'_, F2Spec> {
        Wuf9W::new(self, 1)
    }
    #[doc = "Bit 2 - Wakeup Flag for LLWU_P10"]
    #[inline(always)]
    pub fn wuf10(&mut self) -> Wuf10W<'_, F2Spec> {
        Wuf10W::new(self, 2)
    }
    #[doc = "Bit 3 - Wakeup Flag for LLWU_P11"]
    #[inline(always)]
    pub fn wuf11(&mut self) -> Wuf11W<'_, F2Spec> {
        Wuf11W::new(self, 3)
    }
    #[doc = "Bit 4 - Wakeup Flag for LLWU_P12"]
    #[inline(always)]
    pub fn wuf12(&mut self) -> Wuf12W<'_, F2Spec> {
        Wuf12W::new(self, 4)
    }
    #[doc = "Bit 5 - Wakeup Flag for LLWU_P13"]
    #[inline(always)]
    pub fn wuf13(&mut self) -> Wuf13W<'_, F2Spec> {
        Wuf13W::new(self, 5)
    }
    #[doc = "Bit 6 - Wakeup Flag for LLWU_P14"]
    #[inline(always)]
    pub fn wuf14(&mut self) -> Wuf14W<'_, F2Spec> {
        Wuf14W::new(self, 6)
    }
    #[doc = "Bit 7 - Wakeup Flag for LLWU_P15"]
    #[inline(always)]
    pub fn wuf15(&mut self) -> Wuf15W<'_, F2Spec> {
        Wuf15W::new(self, 7)
    }
}
