...
impl W {
    #[doc = "Bit 0 - Frame sync direction"]
    #[inline(always)]
    pub fn fsd(&mut self) -> FsdW<'_, Rcr4Spec> {
        FsdW::new(self, 0)
    }
    #[doc = "Bit 1 - Frame sync polarity"]
    #[inline(always)]
    pub fn fsp(&mut self) -> FspW<'_, Rcr4Spec> {
        FspW::new(self, 1)
    }
    #[doc = "Bit 3 - Frame sync early"]
    #[inline(always)]
    pub fn fse(&mut self) -> FseW<'_, Rcr4Spec> {
        FseW::new(self, 3)
    }
    #[doc = "Bit 4 - MSB first"]
    #[inline(always)]
    pub fn mf(&mut self) -> MfW<'_, Rcr4Spec> {
        MfW::new(self, 4)
    }
    #[doc = "Bits 8:12 - Sync width"]
    #[inline(always)]
    pub fn sywd(&mut self) -> SywdW<'_, Rcr4Spec> {
        SywdW::new(self, 8)
    }
    #[doc = "Bits 16:20 - Frame size"]
    #[inline(always)]
    pub fn frsz(&mut self) -> FrszW<'_, Rcr4Spec> {
        FrszW::new(self, 16)
    }
}
