...
impl W {
    #[doc = "Bits 0:3 - Baud Rate Scaler"]
    #[inline(always)]
    pub fn br(&mut self) -> BrW<'_, Spi1CtarSpec> {
        BrW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Delay After Transfer Scaler"]
    #[inline(always)]
    pub fn dt(&mut self) -> DtW<'_, Spi1CtarSpec> {
        DtW::new(self, 4)
    }
    #[doc = "Bits 8:11 - After SCK Delay Scaler"]
    #[inline(always)]
    pub fn asc(&mut self) -> AscW<'_, Spi1CtarSpec> {
        AscW::new(self, 8)
    }
    #[doc = "Bits 12:15 - PCS to SCK Delay Scaler"]
    #[inline(always)]
    pub fn cssck(&mut self) -> CssckW<'_, Spi1CtarSpec> {
        CssckW::new(self, 12)
    }
    #[doc = "Bits 16:17 - Baud Rate Prescaler"]
    #[inline(always)]
    pub fn pbr(&mut self) -> PbrW<'_, Spi1CtarSpec> {
        PbrW::new(self, 16)
    }
    #[doc = "Bits 18:19 - Delay after Transfer Prescaler"]
    #[inline(always)]
    pub fn pdt(&mut self) -> PdtW<'_, Spi1CtarSpec> {
        PdtW::new(self, 18)
    }
    #[doc = "Bits 20:21 - After SCK Delay Prescaler"]
    #[inline(always)]
    pub fn pasc(&mut self) -> PascW<'_, Spi1CtarSpec> {
        PascW::new(self, 20)
    }
    #[doc = "Bits 22:23 - PCS to SCK Delay Prescaler"]
    #[inline(always)]
    pub fn pcssck(&mut self) -> PcssckW<'_, Spi1CtarSpec> {
        PcssckW::new(self, 22)
    }
    #[doc = "Bit 24 - LBS First"]
    #[inline(always)]
    pub fn lsbfe(&mut self) -> LsbfeW<'_, Spi1CtarSpec> {
        LsbfeW::new(self, 24)
    }
    #[doc = "Bit 25 - Clock Phase"]
    #[inline(always)]
    pub fn cpha(&mut self) -> CphaW<'_, Spi1CtarSpec> {
        CphaW::new(self, 25)
    }
    #[doc = "Bit 26 - Clock Polarity"]
    #[inline(always)]
    pub fn cpol(&mut self) -> CpolW<'_, Spi1CtarSpec> {
        CpolW::new(self, 26)
    }
    #[doc = "Bits 27:30 - Frame Size"]
    #[inline(always)]
    pub fn fmsz(&mut self) -> FmszW<'_, Spi1CtarSpec> {
        FmszW::new(self, 27)
    }
    #[doc = "Bit 31 - Double Baud Rate"]
    #[inline(always)]
    pub fn dbr(&mut self) -> DbrW<'_, Spi1CtarSpec> {
        DbrW::new(self, 31)
    }
}
