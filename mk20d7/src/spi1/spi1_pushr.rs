...
impl W {
    #[doc = "Bits 0:15 - Transmit Data"]
    #[inline(always)]
    pub fn txdata(&mut self) -> TxdataW<'_, Spi1PushrSpec> {
        TxdataW::new(self, 0)
    }
    #[doc = "Bits 16:21 - no description available"]
    #[inline(always)]
    pub fn pcs(&mut self) -> PcsW<'_, Spi1PushrSpec> {
        PcsW::new(self, 16)
    }
    #[doc = "Bit 26 - Clear Transfer Counter."]
    #[inline(always)]
    pub fn ctcnt(&mut self) -> CtcntW<'_, Spi1PushrSpec> {
        CtcntW::new(self, 26)
    }
    #[doc = "Bit 27 - End Of Queue"]
    #[inline(always)]
    pub fn eoq(&mut self) -> EoqW<'_, Spi1PushrSpec> {
        EoqW::new(self, 27)
    }
    #[doc = "Bits 28:30 - Clock and Transfer Attributes Select."]
    #[inline(always)]
    pub fn ctas(&mut self) -> CtasW<'_, Spi1PushrSpec> {
        CtasW::new(self, 28)
    }
    #[doc = "Bit 31 - Continuous Peripheral Chip Select Enable"]
    #[inline(always)]
    pub fn cont(&mut self) -> ContW<'_, Spi1PushrSpec> {
        ContW::new(self, 31)
    }
}
