    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(I2c1::Disabled)
    }
    #[doc = "Clock enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(I2c1::Enabled)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(Uart3::Disabled)
    }
    #[doc = "Clock enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(Uart3::Enabled)
    }
}
...
impl W {
    ...
    #[doc = "Bit 7 - I2C1 Clock Gate Control"]
    #[inline(always)]
    pub fn i2c1(&mut self) -> I2c1W<'_, Scgc4Spec> {
        I2c1W::new(self, 7)
    }
    #[doc = "Bit 10 - UART0 Clock Gate Control"]
    #[inline(always)]
    ...
    #[doc = "Bit 13 - UART3 Clock Gate Control"]
    #[inline(always)]
    pub fn uart3(&mut self) -> Uart3W<'_, Scgc4Spec> {
        Uart3W::new(self, 13)
    }
    #[doc = "Bit 18 - USB Clock Gate Control"]
    #[inline(always)]
