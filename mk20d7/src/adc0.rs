...
impl RegisterBlock {
    ...
    #[doc = ""]
    #[doc = "<div class=\"warning\">`n` is the index of register in the array. `n == 0` corresponds to `SC1A` register.</div>"]
    #[inline(always)]
    ...
    #[doc = ""]
    #[doc = "<div class=\"warning\">`n` is the index of register in the array. `n == 0` corresponds to `RA` register.</div>"]
    #[inline(always)]
