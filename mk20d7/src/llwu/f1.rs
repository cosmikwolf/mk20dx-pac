...
impl W {
    #[doc = "Bit 0 - Wakeup Flag for LLWU_P0"]
    #[inline(always)]
    pub fn wuf0(&mut self) -> Wuf0W<'_, F1Spec> {
        Wuf0W::new(self, 0)
    }
    #[doc = "Bit 1 - Wakeup Flag for LLWU_P1"]
    #[inline(always)]
    pub fn wuf1(&mut self) -> Wuf1W<'_, F1Spec> {
        Wuf1W::new(self, 1)
    }
    #[doc = "Bit 2 - Wakeup Flag for LLWU_P2"]
    #[inline(always)]
    pub fn wuf2(&mut self) -> Wuf2W<'_, F1Spec> {
        Wuf2W::new(self, 2)
    }
    #[doc = "Bit 3 - Wakeup Flag for LLWU_P3"]
    #[inline(always)]
    pub fn wuf3(&mut self) -> Wuf3W<'_, F1Spec> {
        Wuf3W::new(self, 3)
    }
    #[doc = "Bit 4 - Wakeup Flag for LLWU_P4"]
    #[inline(always)]
    pub fn wuf4(&mut self) -> Wuf4W<'_, F1Spec> {
        Wuf4W::new(self, 4)
    }
    #[doc = "Bit 5 - Wakeup Flag for LLWU_P5"]
    #[inline(always)]
    pub fn wuf5(&mut self) -> Wuf5W<'_, F1Spec> {
        Wuf5W::new(self, 5)
    }
    #[doc = "Bit 6 - Wakeup Flag for LLWU_P6"]
    #[inline(always)]
    pub fn wuf6(&mut self) -> Wuf6W<'_, F1Spec> {
        Wuf6W::new(self, 6)
    }
    #[doc = "Bit 7 - Wakeup Flag for LLWU_P7"]
    #[inline(always)]
    pub fn wuf7(&mut self) -> Wuf7W<'_, F1Spec> {
        Wuf7W::new(self, 7)
    }
}
