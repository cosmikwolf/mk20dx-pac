...
impl W {
    ...
    #[doc = "Bits 8:9 - Master 4 Access Protection"]
    #[inline(always)]
    pub fn m4ap(&mut self) -> M4apW<'_, PfaprSpec> {
        M4apW::new(self, 8)
    }
    #[doc = "Bits 10:11 - Master 5 Access Protection"]
    #[inline(always)]
    pub fn m5ap(&mut self) -> M5apW<'_, PfaprSpec> {
        M5apW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Master 6 Access Protection"]
    #[inline(always)]
    pub fn m6ap(&mut self) -> M6apW<'_, PfaprSpec> {
        M6apW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Master 7 Access Protection"]
    #[inline(always)]
    pub fn m7ap(&mut self) -> M7apW<'_, PfaprSpec> {
        M7apW::new(self, 14)
    }
    #[doc = "Bit 16 - Master 0 Prefetch Disable"]
    #[inline(always)]
    ...
    #[doc = "Bit 20 - Master 4 Prefetch Disable"]
    #[inline(always)]
    pub fn m4pfd(&mut self) -> M4pfdW<'_, PfaprSpec> {
        M4pfdW::new(self, 20)
    }
    #[doc = "Bit 21 - Master 5 Prefetch Disable"]
    #[inline(always)]
    pub fn m5pfd(&mut self) -> M5pfdW<'_, PfaprSpec> {
        M5pfdW::new(self, 21)
    }
    #[doc = "Bit 22 - Master 6 Prefetch Disable"]
    #[inline(always)]
    pub fn m6pfd(&mut self) -> M6pfdW<'_, PfaprSpec> {
        M6pfdW::new(self, 22)
    }
    #[doc = "Bit 23 - Master 7 Prefetch Disable"]
    #[inline(always)]
    pub fn m7pfd(&mut self) -> M7pfdW<'_, PfaprSpec> {
        M7pfdW::new(self, 23)
    }
}
