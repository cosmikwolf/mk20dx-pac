...
impl W {
    #[doc = "Bits 0:7 - Bit clock divide"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, Rcr2Spec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 24 - Bit clock direction"]
    #[inline(always)]
    pub fn bcd(&mut self) -> BcdW<'_, Rcr2Spec> {
        BcdW::new(self, 24)
    }
    #[doc = "Bit 25 - Bit clock polarity"]
    #[inline(always)]
    pub fn bcp(&mut self) -> BcpW<'_, Rcr2Spec> {
        BcpW::new(self, 25)
    }
    #[doc = "Bits 26:27 - MCLK Select"]
    #[inline(always)]
    pub fn msel(&mut self) -> MselW<'_, Rcr2Spec> {
        MselW::new(self, 26)
    }
    #[doc = "Bit 28 - Bit Clock Input"]
    #[inline(always)]
    pub fn bci(&mut self) -> BciW<'_, Rcr2Spec> {
        BciW::new(self, 28)
    }
    #[doc = "Bit 29 - Bit Clock Swap"]
    #[inline(always)]
    pub fn bcs(&mut self) -> BcsW<'_, Rcr2Spec> {
        BcsW::new(self, 29)
    }
    #[doc = "Bits 30:31 - Synchronous Mode"]
    #[inline(always)]
    pub fn sync(&mut self) -> SyncW<'_, Rcr2Spec> {
        SyncW::new(self, 30)
    }
}
