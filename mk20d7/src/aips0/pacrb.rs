...
impl W {
    #[doc = "Bit 0 - Trusted protect"]
    #[inline(always)]
    pub fn tp7(&mut self) -> Tp7W<'_, PacrbSpec> {
        Tp7W::new(self, 0)
    }
    #[doc = "Bit 1 - Write protect"]
    #[inline(always)]
    pub fn wp7(&mut self) -> Wp7W<'_, PacrbSpec> {
        Wp7W::new(self, 1)
    }
    #[doc = "Bit 2 - Supervisor protect"]
    #[inline(always)]
    pub fn sp7(&mut self) -> Sp7W<'_, PacrbSpec> {
        Sp7W::new(self, 2)
    }
    #[doc = "Bit 4 - Trusted protect"]
    #[inline(always)]
    pub fn tp6(&mut self) -> Tp6W<'_, PacrbSpec> {
        Tp6W::new(self, 4)
    }
    #[doc = "Bit 5 - Write protect"]
    #[inline(always)]
    pub fn wp6(&mut self) -> Wp6W<'_, PacrbSpec> {
        Wp6W::new(self, 5)
    }
    #[doc = "Bit 6 - Supervisor protect"]
    #[inline(always)]
    pub fn sp6(&mut self) -> Sp6W<'_, PacrbSpec> {
        Sp6W::new(self, 6)
    }
    #[doc = "Bit 8 - Trusted protect"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - Trusted protect"]
    #[inline(always)]
    pub fn tp4(&mut self) -> Tp4W<'_, PacrbSpec> {
        Tp4W::new(self, 12)
    }
    #[doc = "Bit 13 - Write protect"]
    #[inline(always)]
    pub fn wp4(&mut self) -> Wp4W<'_, PacrbSpec> {
        Wp4W::new(self, 13)
    }
    #[doc = "Bit 14 - Supervisor protect"]
    #[inline(always)]
    pub fn sp4(&mut self) -> Sp4W<'_, PacrbSpec> {
        Sp4W::new(self, 14)
    }
    #[doc = "Bit 16 - Trusted protect"]
    #[inline(always)]
    pub fn tp3(&mut self) -> Tp3W<'_, PacrbSpec> {
        Tp3W::new(self, 16)
    }
    #[doc = "Bit 17 - Write protect"]
    #[inline(always)]
    pub fn wp3(&mut self) -> Wp3W<'_, PacrbSpec> {
        Wp3W::new(self, 17)
    }
    #[doc = "Bit 18 - Supervisor protect"]
    #[inline(always)]
    pub fn sp3(&mut self) -> Sp3W<'_, PacrbSpec> {
        Sp3W::new(self, 18)
    }
    #[doc = "Bit 20 - Trusted protect"]
    #[inline(always)]
    pub fn tp2(&mut self) -> Tp2W<'_, PacrbSpec> {
        Tp2W::new(self, 20)
    }
    #[doc = "Bit 21 - Write protect"]
    #[inline(always)]
    pub fn wp2(&mut self) -> Wp2W<'_, PacrbSpec> {
        Wp2W::new(self, 21)
    }
    #[doc = "Bit 22 - Supervisor protect"]
    #[inline(always)]
    pub fn sp2(&mut self) -> Sp2W<'_, PacrbSpec> {
        Sp2W::new(self, 22)
    }
    #[doc = "Bit 24 - Trusted protect"]
    #[inline(always)]
